---
title: Development Stack & Tools
description: Development Stack & Tools
...
+ [Azure Data Studio](https://docs.microsoft.com/en-us/sql/azure-data-studio/what-is?view=sql-server-ver15) - Cross-platform database studio dari Microsoft
...
+ .NET Editor: [Visual Studio](https://visualstudio.microsoft.com/)
...
### Hybrid
+ [React Native](https://reactnative.dev/) - Sedang proses migrasi ke Flutter
...
+ [Mocha.js](https://mochajs.org/) Javascript testing framework
+ [Cypress](https://www.cypress.io/) E2E Javascript testing framework
...
+ [Qase.io](https://qase.io/) Test Management Tools
